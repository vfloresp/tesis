...
class VAE:
    """
    VAE represents a Deep Concolution variational autoencoder architecture with
    ...
    def save(self, save_folder="."):
        self._create_folder_if_doesnt_existe(save_folder)
        self._save_parameters(save_folder)
        self._save_weights(save_folder)

    def _create_folder_if_doesnt_existe(self, folder):
    ...
    def _save_parameters(self, save_folder):
        ...
        save_path = os.path.join(save_folder, "parameters_va.pkl")
        with open(save_path, "wb") as f:
            pickle.dump(parameters, f)

    def _save_weights(self, save_folder):
        save_path = os.path.join(save_folder, "weights_va.h5")
    ...
    def load(cls, save_folder="."):
        parameters_path = os.path.join(save_folder, "parameters_va.pkl")
        with open(parameters_path, "rb") as f:
            parameters = pickle.load(f)
        va_autoencoder = VAE(*parameters)
        weights_path = os.path.join(save_folder, "weights_va.h5")
        va_autoencoder.load_weights(weights_path)
    ...
    def _add_conv_transpose_layers(self, x):
        ...
        loop trhough all the conv layers in reverse order and stop at the
        first layer
        Args:
            x ([type]): [description]
        """
...
if __name__ == "__main__":
    ...
    variational_autonecoder.summary()
